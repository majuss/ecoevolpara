...
**Q:**
   **A harddisk seems to be faulty what do I have to do?**
**A:**
...
**A:** 
   **First check for a false alarm. Therefore you need to understand how it works, see here "link to section custom cron"**
